        ...
        <div className="equipe-main-layout">
            ...
            <div className="cyber-card legendary admin-main">
                ...
                <div className="profile-header">
                    <div className="img-frame" style={{ width: '120px', height: '120px' }}>
                        <img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Steve" alt="Steve" />
                    </div>
                    <td className="name-box">
                      <div><h2>Pickles</h2></div>
                      <div><h3>Rodrigo R. Camellini</h3></div>
                    </td>                    
                </div>
            ...
            <div className="colaboradores-grid">
                ...
                <div className="cyber-card angelic">
                    ...
                    <div className="profile-header">
                        <div className="img-frame"><img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Luna" alt="Colab" /></div>
                ...
                <div className="cyber-card satanic">
                    <span className="tier-label">— Colaborador</span>
                    <div className="profile-header">
                        <div className="img-frame"><img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Kael" alt="Colab" /></div>
                ...
                <div className="cyber-card heroic">
                    <span className="tier-label">— Colaborador</span>
                    <div className="profile-header">
                        <div className="img-frame"><img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Rex" alt="Colab" /></div>
                ...
                <div className="cyber-card set">
                    <span className="tier-label">— Colaborador</span>
                    <div className="profile-header">
                        <div className="img-frame"><img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Borg" alt="Colab" /></div>
                ...
                <div className="cyber-card mythic">
                    ...
                    <div className="profile-header">
                        <div className="img-frame"><img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Zora" alt="Colab" /></div>
                ...
                <div className="cyber-card common">
                    <span className="tier-label">— Colaborador</span>
                    <div className="profile-header">
                        <div className="img-frame"><img onError={(e) => e.target.style.display = 'none'} src="https://api.dicebear.com/7.x/avataaars/svg?seed=Pippin" alt="Colab" /></div>
