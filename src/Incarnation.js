    ...
    <div className="min-h-screen bg-[#0f111a] text-gray-200 font-sans flex flex-col">
              ...
              <div className="relative" onMouseEnter={() => setIsBuilderOpen(true)} onMouseLeave={() => setIsBuilderOpen(false)}>
                ...
                {isBuilderOpen && (
                  <div className="absolute top-full left-0 w-48 bg-[#0b0d14] border border-white/10 py-2 rounded shadow-xl text-[11px]">
                    ...
                    <button onClick={() => navigate('/incarnation')} className="flex items-center justify-between w-full text-left px-4 py-2 bg-white/5 text-orange-500 uppercase tracking-widest font-bold">
                      Incarnation <TagS9 />
                    </button>
                  </div>
                )}
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-2xl w-full bg-white/5 border border-white/10 rounded-2xl p-12 backdrop-blur-sm relative overflow-hidden group">
          <div className="absolute -top-24 -left-24 w-48 h-48 bg-purple-500/10 rounded-full blur-3xl group-hover:bg-purple-500/20 transition-colors duration-700"></div>
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-white mb-4 tracking-tighter uppercase">
              INCARNATION <span className="text-orange-500">SEASON</span>
            </h1>
            
            <p className="text-xl text-gray-400 mb-8 max-w-md mx-auto leading-relaxed">
              Explore o novo sistema de Incarnation e as mudanças épicas da season 9.
            </p>
            ...
            <p className="text-sm text-gray-500 font-medium uppercase tracking-widest">
              Informações Nova Season Incarnation
            </p>
          </div>
        </div>
      </main>
